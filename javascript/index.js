...
obtainInstruction("steak", 0)
  .then((step0) => {
    ...
    return obtainInstruction("steak", 1); // Obtain next step and return the promise
  })
  .then((step1) => {
...
async function makeBroccoli() {
  try {
    ...
    console.error("An error occurred while making broccoli:", error);
    document.querySelector(
      "#broccoli"
    ).innerHTML += `<li>Error preparing broccoli.</li>`;
  }
}
...
const allPromises = [step0, step1, step2, step3, step4, step5, step6, step7];
